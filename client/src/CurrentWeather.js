            ...
            <div className="row">
                <div className="col">
                    <header className="App-header flex-grow">
                        ...
                        <div className="h-100">
                            <h3 className="lat-lon d-flex justify-content-center">Latitude & Longitude:</h3>
                            <h1 className="d-flex justify-content-center pb-5">{lat.toFixed(2)} {lon.toFixed(2)}</h1>
                            <div className="col-7">
                                <WeatherIcons className="d-flex justify-content-end pb-4 mr-5" name="cloud" size="4x" />
                            </div>
                            <h1 className="temp d-flex justify-content-center pb-4">{apparentTemperature.toFixed(0)} &deg;F</h1>
                        </div>
                    </header>
                </div>
            </div>
